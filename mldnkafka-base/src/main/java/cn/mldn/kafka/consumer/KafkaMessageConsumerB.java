	...
	public static void main(String[] args) throws Exception {
		...
		while (flag) {
			...
			for (ConsumerRecord<Integer, String> record : records) {
				System.out.println("【消费端 - B】offset = " + record.offset() + "、key = " + record.key() + "、value = " + record.value());
			}
		}
		consumer.close(); 
	}
