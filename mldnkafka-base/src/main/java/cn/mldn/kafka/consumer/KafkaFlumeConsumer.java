...
public class KafkaFlumeConsumer {
	public static final String TOPIC_NAME = "mldn-flume" ;	// 主题
	...
	public static void main(String[] args) throws Exception {
		...
		props.setProperty(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class.getName()); // Key类型为Integer
